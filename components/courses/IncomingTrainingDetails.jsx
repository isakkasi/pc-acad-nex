...
const IncomingTrainingDetails = ({ training }) => {
    return (
                        ...
                        <div className="col-lg-4">
                            <div className="project-information">
                                ...
                                <ul>
                                    ...
                                    <li style={{ fontSize: "1rem" }}>
                                        Dates <span style={{ marginLeft: "16px", textAlign: "right" }}>{training.dates}</span>
                                    </li>
                                    <li style={{ fontSize: "1rem" }}>
                                        Time <span style={{ marginLeft: "16px", textAlign: "right" }}>{training.time}</span>
                                    </li>
                                    <li style={{ fontSize: "1rem" }}>
                                        Theory location <span style={{ marginLeft: "16px", textAlign: "right" }}>{training.locationTheory}</span>
                                    </li>
                                    <li style={{ fontSize: "1rem" }}>
                                        Practical location <span style={{ marginLeft: "16px", textAlign: "right" }}>{training.locationPractical}</span>
                                    </li>
                                    <li style={{ fontSize: "1rem" }}>
                                        Approval <span style={{ marginLeft: "16px", textAlign: "right" }}>{training.approval}</span>
                                    </li>
                                    <li style={{ fontSize: "1rem" }}>
                                        Price <span style={{ marginLeft: "16px", textAlign: "right" }}>{training.price}</span>
                                    </li>
                                </ul>
                                <div className="mt-4">
                                    <Link href={training.requestFormLink} className="theme-btn w-100 text-center" target="_blank" rel="noopener noreferrer">
...
export default IncomingTrainingDetails;
